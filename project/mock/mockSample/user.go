// generate go mock 代码, mock Index、Embed、Embedded 三个interface
//go:generate mockgen -destination mock_user/mock_user.go bookReadingNote/project/mock/mockSample Index,Embed,Embedded
...
import (
	"bookReadingNote/project/mock/mockSample/imp1"
	renamed2 "bookReadingNote/project/mock/mockSample/imp2"
	. "bookReadingNote/project/mock/mockSample/imp3"
	"bookReadingNote/project/mock/mockSample/imp4"
)
